...
<title>::. MBCET MANAGEMENT SYSTEM .::</title>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="5" cellspacing="0">
			...
			<tr>
            	<td>IA2</td>
            	<td>
                	<input type="text" name="midermtxtt" id="textbox" value="<?php echo $rs_upd['ia2'];?> "/>
                </td>
            </tr>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="5" cellspacing="0">
			...
			<tr>
            	<td>IA2</td>
            	<td>
                	<input type="text" name="midermtxtt" id="textbox" />
                </td>
            </tr>
